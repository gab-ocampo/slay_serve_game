...
function App() {
    ...
    return (
      <div className="landing">
        ...
        <div className="button-group">
          <button onClick={() => setPlayer('Slay')}>I am Slay</button>
          <button onClick={() => setPlayer('Serve')}>I am Serve</button>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="app-container">
      <h1 className="title">Slay or Serve?</h1>
      <p className="subtitle">You are playing as: <strong>{player}</strong></p>
      <div className="grid">
